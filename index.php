...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<br />
			<br />
			<h3 align="center"><?echo "$fullname"?></a></h3><br />
			<br /><br />
			<?php
			...
			<div class="col-md-4">
				<form method="post" action="index.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						<img src="images/<?php echo $row["image"]; ?>" class="img-responsive" style="height: 90px; width: 80px;"/><br />
            ...
            <table>
				<tr>
						<td colspan="3" align="right">Amount</br></td>
						<td align="right">Ksh. <?php echo number_format($total, 2); ?></td>
						<td></td>
					</tr>
                 </table>
					<input type="text" name="phoneNo"  class="form-control" placeholder="Mpesa Number(2547...)" />
					<input type="submit" name="lipa" style="margin-top:5px;" class="btn btn-success" value="Pay" />
				</form>
			</div>
		</div>
	</div>
